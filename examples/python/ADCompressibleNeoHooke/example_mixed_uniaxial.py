...
print("Running example for FiniteStrain material: ADCOMPRESSIBLENEOHOOKE")
...
solver = marmot.solvers.FiniteStrainSolver("ADCOMPRESSIBLENEOHOOKE", properties, options)
