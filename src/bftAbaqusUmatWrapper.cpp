...
namespace bft {
                             ...
                             pUmatType                  umatPointer )
    {
        ...
        ( *umatPointer )( &stress( 0 ),
                          ...
                          sCD,
                          intParamLocal,
                          &dStressDIntParamNonlocal( 0 ),
                          &dIntParamLocalDStrain( 0 ),
                          nonLocalRadius,
                          strainOld.data(),
                          dStrain.data(),
                          &time[0],
    ...
    void simpleUmatPlaneStressNonLocal( Ref<Matrix6>               dStressdStrain,
                                        Ref<Vector6>               stress,
                                        double&                    intParamLocal,
                                        Ref<Vector6>               dStressDIntParamNonlocal,
                                        Ref<Vector6>               dIntParamLocalDStrain,
                                        ...
                                        pUmatType                  umatPointer )
    {
        ...
        while ( true ) {
            ...
            simpleUmatNonLocal( dStressdStrain,
                                stressTemp,
                                intParamLocal,
                                dStressDIntParamNonlocal,
                                dIntParamLocalDStrain,
                                nonLocalRadius,
                                stateVarsTemp,
                                strainOld,
                                dStrainTemp,
            ...
            if ( pNewdT < 1.0 ) {
                // pNewdT = 1e36;
                // return umatPlaneStressBisectionMethodNonLocal( dStressdStrain, stressTemp, intParamLocal,
                // dStressDIntParamNonlocal, dIntParamLocalDStrain,
    ...
    void umatPlaneStressBisectionMethodNonLocal( Ref<MatrixXd>              dStressdStrain,
                                                 Ref<VectorXd>              stress,
                                                 double&                    intParamLocal,
                                                 Ref<Vector6>               dStressDIntParamNonlocal,
                                                 Ref<Vector6>               dIntParamLocalDStrain,
