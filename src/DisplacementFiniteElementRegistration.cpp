...
namespace DisplacementFiniteElementRegistration {
    ...
    const static bool C3D8_isRegistered = userLibrary::MarmotElementFactory::
        registerElement( "C3D8", userLibrary::ElementCode::C3D8, []( int elementID ) -> MarmotElement* {
    ...
    const static bool C3D20_isRegistered = userLibrary::MarmotElementFactory::
        registerElement( "C3D20", userLibrary::ElementCode::C3D20, []( int elementID ) -> MarmotElement* {
    ...
    const static bool C3D20R_isRegistered = userLibrary::MarmotElementFactory::
        registerElement( "C3D20R", userLibrary::ElementCode::C3D20R, []( int elementID ) -> MarmotElement* {
            return new DisplacementFiniteElement<3, 20>( elementID,
    ...
    const static bool
        T2D2_isRegistered = userLibrary::MarmotElementFactory::registerElement( "T2D2",
