...
namespace UelDisplacementFactory{
    ...
    BftUel* generateUelT2D2( 
                            int noEl)
    {
            auto uelT2D2 =  std::unique_ptr<BftUel> ( new UelDisplacement<1, 2 >( noEl,
    ...
    BftUel* generateUelC3D8( int noEl){
            return new UelDisplacement< 3, 8 >( 
                                  noEl, 
                                   bft::NumIntegration::IntegrationTypes::FullIntegration,
    ...
    BftUel* generateUelC3D20( int noEl){
            return new UelDisplacement< 3, 20 >( 
                                  noEl, 
                                   bft::NumIntegration::IntegrationTypes::FullIntegration,
