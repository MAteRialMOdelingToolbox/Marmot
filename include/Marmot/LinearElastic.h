...
namespace Marmot::Materials {
	...
	enum class Type { Isotropic = 2, /**< Number of materialProperties equals 2.*/
	       	          TransverseIsotropic = 8, /**< Number of materialProperties equals 8. 5 to describe
         * 						the material behavior and 3 components of a normal vector. The latter
         * 						corresponds to the x1 - axis of the principal material directions and defines the
         * 						materials plane of isotropy (directions x2 and x3).*/

			  Orthotropic = 12 /**< Number of materialProperties equals 12. 9 to describe material behavior and
         * 	   			        3 components of a normal vector. The latter corresponds to the x1 - axis of the principal
         * 	        			material directions. */
