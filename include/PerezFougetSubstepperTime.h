...
namespace bft{
    template <int s>
    PerezFougetSubstepperTime<s>::PerezFougetSubstepperTime(  
    ...
    template <int s>
    void PerezFougetSubstepperTime<s>::extendConsistentTangent(const Matrix6& CelT, const TangentSizedMatrix& matTangent)
    {
