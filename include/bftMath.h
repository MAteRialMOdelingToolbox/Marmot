...
namespace bft {
    namespace Math {
        ...
        template <typename functionType, typename yType, typename time, typename... Args>
        yType explicitEuler( yType yN, time dt, functionType fRate, Args&&... fRateArgs )
        {
            return yN + fRate( yN, fRateArgs... ) * dt;
        }

        template <int ySize, typename functionType, typename yType, typename time, typename... Args>
        yType semiImplicitEuler( yType yN, time dt, functionType fRate, Args&&... fRateArgs )
        {
        ...
        template <typename functionType, typename yType, typename time, typename... Args>
        yType explicitEulerRichardson( yType yN, time dt, functionType fRate, Args&&... fRateArgs )
        {
