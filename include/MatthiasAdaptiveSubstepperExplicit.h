...
namespace bft{
            ...
            const IntegrationStateVector& stateVars)
    {
            if(currentState == FullStep){
                ...
                consistentTangentProgressFullTemp.applyOnTheLeft(I77 - dYdXOld);
                consistentTangentProgressFullTemp += currentSubstepSize * I76 * Cel;
                consistentTangentProgressFullTemp.applyOnTheLeft(dXdY);
                //consistentTangentProgressFullTemp = dXdY *( (I77 - dYdXOld) * consistentTangentProgressFullTemp +  currentSubstepSize * I76 * Cel); 
                //consistentTangentProgressFullTemp = consistentTangentProgress;
                ...
                consistentTangentProgressHalfTemp.applyOnTheLeft(I77 - dYdXOld);
                consistentTangentProgressHalfTemp += 0.5 * currentSubstepSize * I76 * Cel;
                consistentTangentProgressHalfTemp.applyOnTheLeft(dXdY);
                //consistentTangentProgressHalfTemp = dXdY *( (I77 - dYdXOld) * consistentTangentProgressHalfTemp +  0.5 * currentSubstepSize * I76 * Cel); 
                //consistentTangentProgressFullTemp = dXdY *( (I77 - dYdXOld) * consistentTangentProgressFullTemp+  currentSubstepSize * I76 * Cel); 
                //consistentTangentProgressHalfTemp = consistentTangentProgress;
                ...
                //consistentTangentProgress = consistentTangentProgressHalfTemp  ;
                //stressProgress = stressProgressHalfTemp  ;
                //stateProgress =stateProgressHalfTemp  ;
    ...
    {  
            switch(currentState)
            {
                case FullStep:{
                    ...
                    consistentTangentProgress += currentSubstepSize * I76 * Cel;
