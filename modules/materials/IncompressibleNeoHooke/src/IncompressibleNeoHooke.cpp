...
namespace Marmot::Materials {
  ...
  void IncompressibleNeoHooke::computeStress( ConstitutiveResponse< 3 >& response,
                                              ...
                                              const TimeIncrement&       timeIncrement ) const
  {
    ...
    const auto [psi_,
                dPsi_dC,
                d2Psi_dCdC] = EnergyDensityFunctions::Incompressible::SecondOrderDerived::NeoHookePotential( C, mu );
