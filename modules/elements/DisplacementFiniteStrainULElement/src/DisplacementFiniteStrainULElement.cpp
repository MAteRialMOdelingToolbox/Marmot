...
namespace Marmot::Elements::Registration {
  ...
  const static bool C3D8UL_isRegistered = Marmot::Factory::MarmotElementFactory::
  ...
  const static bool C3D20RUL_isRegistered = Marmot::Factory::MarmotElementFactory::
  ...
  const static bool C3D20UL_isRegistered = Marmot::Factory::MarmotElementFactory::
