...
namespace Marmot::ContinuumMechanics::Plasticity {
  ...
  // clang-format off
     ...
     *   const ContinuumMechanics::Invariants::HaighWestergaardCoordinates hw = { 1.0, -10, 0 };
  ...
  public:
     ...
     */
    template < typename T >
    T yieldFunction( const ContinuumMechanics::Invariants::HaighWestergaardCoordinates< T >& hw,
    ...
    std::tuple< T, T, T > dYieldFunction_dHaighWestergaard(
      const ContinuumMechanics::Invariants::HaighWestergaardCoordinates< T >& hw,
      const double                                                            varEps = 0.0 ) const
    {
